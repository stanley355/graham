...
table! {
    comparative_ratios (id) {
        ...
        stock_id -> Int4,
        year -> Int4,
        gross_profit_margin -> Int4,
        operating_profit_margin -> Int4,
        net_profit_margin -> Int4,
        current_asset_return -> Int4,
        tangible_asset_return -> Int4,
        total_liability_return -> Int4,
        revenue_receivable_return -> Int4,
        revenue_inventory_return -> Int4,
        current_asset_liabilities_return -> Int4,
        tangible_asset_total_liabilities_return -> Int4,
    }
}
